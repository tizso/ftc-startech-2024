...
import org.firstinspires.ftc.teamcode.trajectorysequence.util.Encoder;
...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 8.7; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 3.6; // in; offset of the lateral wheel

    public static double X_MULTIPLER = 0.987898;
    public static double Y_MULTIPLER = 0.989596;
